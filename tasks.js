...
let items = [
  {
    name: "Biscuits",
    quantity: 5,
    description: `I really love picnic biscuits`,
  },
  {
    name: "MTN",
    quantity: 3,
    description: "No comment, network is just wonderful",
  },
];
// Event Listeners

// This event is fired when the user clicks the submit button
...
// This event is fired when the DOM has been parsed 
...
// This function removes an item from the page and from the array
